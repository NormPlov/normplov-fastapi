...
class CareerCategoryResponsibility(Base):
    __tablename__ = "career_category_responsibilities"
    ...
    # Relationships
    career_category = relationship("CareerCategory", back_populates="responsibilities")
